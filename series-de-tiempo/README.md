...
Nowcast: Predicción de la inflación para el mes en curso utilizando varios métodos ingenuos y datos disponibles de encuestas.
Forecast: Predicción de la inflación para el mes siguiente utilizando técnicas sencillas y avanzadas.
Modelo AR(2): Construcción de un modelo autorregresivo (AR) para proyectar la inflación a 12 meses.
Comparación de Modelos: Comparar los resultados de diferentes pronósticos (promedio histórico, último dato disponible, modelo AR(2), etc.) y evaluar su precisión.
...
Nowcast: Pronóstico de la inflación para el mes en curso utilizando métodos como la última observación, promedio histórico, promedio de las últimas 50 observaciones, pronóstico constante, y las encuestas del Banco Central e IMCE.
Pronóstico: Proyección de la inflación para el mes siguiente utilizando métodos similares y comparación con los resultados de Nowcast.
Análisis: Evaluación crítica del pronóstico de inflación de las encuestas del Banco Central frente al IMCE, utilizando los resultados de proyectos anteriores y del proyecto actual.
Modelo AR(2): Pronóstico de la inflación utilizando un modelo AR(2) con parámetros ajustados en ventanas rodantes de 50 observaciones.
Pronóstico con AR(2): Pronóstico a 12 meses de inflación usando el modelo AR(2) y evaluación de si la inflación se mantendrá dentro del rango de tolerancia del Banco Central.
Resultados Clave
...
Abre el archivo y navega por las hojas Nowcast, Pronóstico, Análisis, Modelo AR(2) y Pronóstico con AR(2) para ver los cálculos y pronósticos realizados.
Los cálculos de la Raíz del Error Cuadrático Medio de Proyección (RECM) y las comparaciones de los modelos se encuentran detalladas en cada hoja.
